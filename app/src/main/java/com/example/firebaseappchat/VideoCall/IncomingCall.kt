...
abstract class IncomingCall : AppCompatActivity(), Session.SessionListener,
    PublisherKit.PublisherListener {

    class IncomingCall : AppCompatActivity(), Session.SessionListener,
        PublisherKit.PublisherListener {
